...
contextBridge.exposeInMainWorld('artisys',Object.freeze({...Object.fromEntries(['describe','authState','bootstrap','login','validate','logout','load','action'].map(n=>[n,p=>call(n,p)])),updates}));

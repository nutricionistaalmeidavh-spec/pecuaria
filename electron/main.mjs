...
app.whenReady().then(async()=>{
  ...
  for(const n of ['describe','authState','bootstrap','login','validate','logout','search','alerts','audit','insights','simulateSale','references','load','action'])ipcMain.handle(`artisys:${n}`,(_e,p)=>host.backend[n](p));

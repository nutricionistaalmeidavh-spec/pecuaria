...
export const ACTION_FORMS=Object.freeze({
  ...
  animals:Object.freeze({
    ...
    batchMove:form('Mover animais em lote',[field('animalIds','Animais','list',{placeholder:'brincos/IDs, um por linha'}),field('toLotId','Lote destino','text',{refCollection:'lots'}),field('movedAt','Data/hora','datetime-local'),field('reason','Motivo')],v=>({animalIds:list(v.animalIds),toLotId:clean(v.toLotId),movedAt:dateTime(v.movedAt),reason:clean(v.reason)||'management'})),

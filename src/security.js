...
export const SECURITY_POLICY=Object.freeze({
  admin:['*'],
  manager:['cattle:read','cattle:write','finance:read','finance:write','finance:settle','reports:read','audit:read','session:revoke','settings:read','settings:backup','iot:read','iot:write'],

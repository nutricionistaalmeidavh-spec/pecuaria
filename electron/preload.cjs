...
contextBridge.exposeInMainWorld('artisys',Object.freeze({...Object.fromEntries(['describe','authState','bootstrap','login','validate','logout','search','alerts','audit','insights','simulateSale','reproductionAdmin','userAdmin','fieldSync','references','load','action','maps'].map(n=>[n,p=>call(n,p)])),updates}));

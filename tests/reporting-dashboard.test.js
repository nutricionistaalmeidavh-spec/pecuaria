...
test('presentation exposes reporting and dashboard services without changing contracted screens',async()=>{
...
test('dashboard snapshot derives KPIs and does not persist cache records',async()=>{
  const f=await fixture();
  try{
    await seed(f.db);

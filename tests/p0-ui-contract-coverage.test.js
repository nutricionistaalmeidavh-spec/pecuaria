...
test('product contract certifies the complete 17-screen 61-action surface and supplemental RPCs',async()=>{
  ...
  assert.equal(Object.values(product.actions).flat().length,61);

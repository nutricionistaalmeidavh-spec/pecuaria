...
import {ActionDialog,AnimalDetail,CorralFlow,DataTable,DesktopShell,StatusBanner,WorkspaceScreen} from './components.jsx';
...
function App(){
  ...
  const navigate=id=>{setScreenId(id);setNotice(null);setAnimalDetail(null)};
